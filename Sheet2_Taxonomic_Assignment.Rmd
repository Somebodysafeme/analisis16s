...
#Ya tenemos las variables, por lo que no es necesario volverlas a cargar (además tardan mucho)
```
...
#Vamos a usar los datos SILVA, hay que descargarlos previamente
...
options(Biostrings.coloring=TRUE) #ponerle colores al alineamiento

#phangAlign <- phyDat(as(alignment, "matrix"), type="DNA")
phangAlign<- readRDS("objects/Sheet2/phangAlign.rds")
#Objeto que necesita para hacer los alineamientos y la construcción
